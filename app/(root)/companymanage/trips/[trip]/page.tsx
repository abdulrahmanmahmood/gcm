...
const VehicleViewPage = ({ params }: { params: { trip: string } }) => {
  const vehicleId = parseInt(params.trip, 10);
  ...
  const {
    ...
    queryFn: () => fetchOneData(`management/trip`, vehicleId, "Fetch Vehicle"),
  ...
  console.log("trip vehcles", vehicle.deliveryNote.vehicle);
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <VehiclePictures
        vehicleId={vehicleId}
        pictures={vehicle.deliveryNote.vehicle.pictures}
        refetch={refetch}
      />
